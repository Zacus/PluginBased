...
"""Architecture guard for isolating FFmpegDecoder seek-request consumption."""
...
def main():
    ...
    require(decoder_cpp.count("m_decodeLoopControl.consumeSeekRequest") >= 2,
            "FFmpegDecoder should use DecodeLoopControl for normal-loop and EOF seek handling")
